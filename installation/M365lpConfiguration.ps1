...
if ($AppCatalogAdmin) {   
  ...
  try {
    ...
    Set-PnPStorageEntity -Key MicrosoftCustomLearningCdn -Value "https://AsahiSPOnline.github.io/custom-learning-office-365/learningpathways/" -Description "Microsoft 365 learning pathways CDN source" -ErrorAction Stop 
  }
  catch {
