...
try {
  ...
  Set-PnPStorageEntity -Key MicrosoftCustomLearningCdn -Value "https://AsahiSPOnline.github.io/custom-learning-office-365/learningpathways/" -Description "CDN source for Microsoft 365 learning pathways Content"
